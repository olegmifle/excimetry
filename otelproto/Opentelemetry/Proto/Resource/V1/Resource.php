...
class Resource extends \Google\Protobuf\Internal\Message
{
     ...
     *           dropped_attributes_count is the number of dropped attributes. If the value is 0, then
     *           no attributes were dropped.
     *     @type array<\Opentelemetry\Proto\Common\V1\EntityRef>|\Google\Protobuf\Internal\RepeatedField $entity_refs
     *           Set of entities that participate in this Resource.
     *           Note: keys in the references MUST exist in attributes of this message.
     *           Status: [Development]
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .opentelemetry.proto.common.v1.EntityRef entity_refs = 3;</code>
     * @param array<\Opentelemetry\Proto\Common\V1\EntityRef>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
