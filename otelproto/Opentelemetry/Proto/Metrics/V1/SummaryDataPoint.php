...
class SummaryDataPoint extends \Google\Protobuf\Internal\Message
{
     ...
     *           doing so.  This is specifically to enforce compatibility w/ OpenMetrics,
     *           see: https://github.com/prometheus/OpenMetrics/blob/v1.0.0/specification/OpenMetrics.md#summary
     *     @type array<\Opentelemetry\Proto\Metrics\V1\SummaryDataPoint\ValueAtQuantile>|\Google\Protobuf\Internal\RepeatedField $quantile_values
     *           (Optional) list of values at different quantiles of the distribution calculated
     *           from the current snapshot. The quantiles must be strictly increasing.
     *     @type int $flags
     *           Flags that apply to this specific data point.  See DataPointFlags
     ...
     *
     * Generated from protobuf field <code>repeated .opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile quantile_values = 6;</code>
     * @param array<\Opentelemetry\Proto\Metrics\V1\SummaryDataPoint\ValueAtQuantile>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
