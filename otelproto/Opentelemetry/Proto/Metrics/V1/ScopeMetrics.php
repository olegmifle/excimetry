...
class ScopeMetrics extends \Google\Protobuf\Internal\Message
{
     ...
     *           Semantically when InstrumentationScope isn't set, it is equivalent with
     *           an empty instrumentation scope name (unknown).
     *     @type array<\Opentelemetry\Proto\Metrics\V1\Metric>|\Google\Protobuf\Internal\RepeatedField $metrics
     *           A list of metrics that originate from an instrumentation library.
     ...
     *
     * Generated from protobuf field <code>repeated .opentelemetry.proto.metrics.v1.Metric metrics = 2;</code>
     * @param array<\Opentelemetry\Proto\Metrics\V1\Metric>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
