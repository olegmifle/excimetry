...
class MetricsData extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type array<\Opentelemetry\Proto\Metrics\V1\ResourceMetrics>|\Google\Protobuf\Internal\RepeatedField $resource_metrics
     *           An array of ResourceMetrics.
     *           For data coming from a single resource this array will typically contain
     *           one element. Intermediary nodes that receive data from multiple origins
     *           typically batch the data before forwarding further and in that case this
     ...
     *
     * Generated from protobuf field <code>repeated .opentelemetry.proto.metrics.v1.ResourceMetrics resource_metrics = 1;</code>
     * @param array<\Opentelemetry\Proto\Metrics\V1\ResourceMetrics>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
